        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-lg font-bold">AssetBridge Nexus</span>
            </div>
            <p className="text-gray-400 text-sm">
              Bridge Real Assets to DeFi. Professional, secure, accessible.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <Link href="/private-credit" className="hover:text-white transition-colors">
                  Private Credit
                </Link>
              </li>
              <li>
